...
from ai.prompts import SYSTEM_PROMPT, DAILY_BRIEF_PROMPT, WEEKLY_SUMMARY_PROMPT, CHAT_PROMPT
...
class Coach:
    ...
    async def weekly_summary(self) -> str:
        """Generate and return the weekly summary message."""
    ...
    async def chat(self, message: str) -> str:
        ...
        # Get recent context for grounded responses
        context = await self._build_context(days=3)
        prompt = CHAT_PROMPT.format(message=message, context=context)
